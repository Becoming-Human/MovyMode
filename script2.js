...
const pageList= document.getElementsByClassName('watchListPage')
const viewWatchlist= document.getElementById('nextPagebtn')
//debugger
...
function displayMovies(movies){
    ...
    movies.forEach((movie) => {
        ...
        <h4>Overview:</h4>
        ${overview}  
        <button class= 'next' class = 'add-btn' > Add to watchlist</button>
        </div>       
